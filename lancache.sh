...
echo -e "${GREEN} ______      _       _____                 _                   _                  _____           _      ${ENDCOLOR}"  
echo -e "${GREEN}|  ____|    (_)     / ____|               (_)                 | |                / ____|         | |         ${ENDCOLOR}"
echo -e "${GREEN}| |__   _ __ _  ___| (___   ___ _ ____   ___  ___   ___  ___  | |     __ _ _ __ | |     __ _  ___| |__   ___ ${ENDCOLOR}"
echo -e "${GREEN}|  __| | '__| |/ __|\___ \ / _ \ '__\ \ / / |/ __| / _ \/ __| | |    / _' | '_ \| |    / _' |/ __| '_ \ / _ \ ${ENDCOLOR}"
echo -e "${GREEN}| |____| |  | | (__ ____) |  __/ |   \ V /| | (__ |  __/\__ \ | |___| (_| | | | | |___| (_| | (__| | | |  __/${ENDCOLOR}"
echo -e "${GREEN}|______|_|  |_|\___|_____/ \___|_|    \_/ |_|\___(_)___||___/ |______\__,_|_| |_|\_____\__,_|\___|_| |_|\___|${ENDCOLOR}"
